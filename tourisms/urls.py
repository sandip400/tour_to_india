...
urlpatterns = [
    ...
    path('hp_7days_new/', hp_7days_new, name="hp_7days_new"),
    ...
    path('kashmir_7days/', kashmir_7days, name="kashmir_7days"),
    path('kashmir_12days/', kashmir_12days, name="kashmir_12days"),
    ...
    path('religious_tourism/',religious_tourism, name='religious_tourism'),
    path('mountain_tourism/',mountain_tourism, name='mountain_tourism'),
    path('beach_vibes_tourism/',beach_vibes_tourism, name='beach_vibes_tourism'),
    path('wildlife_safaris_tourism/',wildlife_safaris_tourism, name='wildlife_safaris_tourism'),
    path('wellness_retreats_tourism/',wellness_retreats_tourism, name='wellness_retreats_tourism'),
    path('culinary_journey_tourism/',culinary_journey_tourism, name='culinary_journey_tourism'),
    path('artisan_workshop_tourism/',artisan_workshop_tourism, name='artisan_workshop_tourism'),
